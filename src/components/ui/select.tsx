...
function Select({ placeholder, options = [], ...props }: SelectProps) {
  return (
    <SelectPrimitive.Root value={props.value} data-slot="select" {...props}>
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-md bg-everies-light-10 px-2 py-1 text-xs whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8",
        className
      )}
      {...props}
    >
